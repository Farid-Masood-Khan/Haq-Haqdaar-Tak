              ...
              <Card>
                <CardContent className="pt-6 relative min-h-[400px]">
                  <AnimatePresence mode="wait">
                    {donationStep === 1 && <DonationDetailsForm />}
                    {donationStep === 2 && <DonationConfirmation />}
                    {donationStep === 3 && <DonationComplete />}
                  </AnimatePresence>
                </CardContent>
              </Card>
            </div>
